...
{% details 余談:荒訳でのChatGPTの活用 %}
  ...
  > * 特定の固有名詞や専門用語を翻訳すべきかは、同等の話題に関する日本語の検索結果を参考にして下さい。例えば *Static Site Generator* が日本語で「静的サイトジェネレータ」と呼ばれていることは検索結> より確認できます。これらは訳して下さい。判断できない場合は私に確認を求めてください。
  ...
  > * 翻訳の際に特定のコンテキストやニュアンスを理解するため、例えば、冒頭で伝えたHexo公式サイトの情報や、例えば「Hexo 静的サイトジェネレータ」「Hexo ブログ」等の日本語検索結果を利用して構いま> ん。
...
{% twitter https://x.com/KentarouTakeda/status/1771397577151537376 %}
...
{% twitter https://x.com/KentarouTakeda/status/1771400756320731266 %}
