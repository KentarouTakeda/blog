---
title: Laravel OpenAPIによる "辛くない" スキーマ駆動開発 - PHPerKaigi 2024 レギュラートーク資料
...
PHPerKaigi 2024 3/8（金） day1 11:15-11:55 レギュラートーク資料です。

**スライド版とテキスト版は全く同じ内容**です。トークとしてご覧頂く場合はスライド版を、資料中のリンクやコードを確認したい場合はテキスト版をご覧ください。
