...
- 草稿は取捨選択せず要素を羅列した状態から始まることがある。構成・取捨選択・優先度の判断まで含めて編集する
- 話題が転換する箇所にはクッションや接続を入れる
...
- セクション冒頭は読者を招き入れる。トークの概要や注目の理由を自然に織り込み、乱暴な結論から入らない
...
- 個人の体験・所感を必ず織り込む。ドキュメントの焼き直しにしない。
